...
public class Vec3f
{
	...
	public boolean equals(Object o)
	{
		...
		// Définir un epsilon pour tolérer des différences très petites
		float epsilon = 0.0005f; // ou une autre valeur adaptée à votre besoin

		// Comparer chaque composante avec une tolérance
		return Math.abs(rhs.x - x) < epsilon &&
			Math.abs(rhs.y - y) < epsilon &&
			Math.abs(rhs.z - z) < epsilon;
	}
}
