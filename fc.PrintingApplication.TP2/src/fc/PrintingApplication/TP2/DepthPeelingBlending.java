 ...
 */
public class DepthPeelingBlending {
    ...
    private int progComposeNoStencil = 0;              // fullscreen quad

    public DepthPeelingBlending(int width, int height, float sXY, float zMinWorld, float zMaxWorld) {
    ...
    public void renderSlice(float z_s) {
        ...
        glUseProgram(progComposeNoStencil);
        glUniform1i(glGetUniformLocation(progComposeNoStencil, "uTexZLower"), 0);
        glUniform1i(glGetUniformLocation(progComposeNoStencil, "uTexZUpper"), 1);
        glUniform1f(glGetUniformLocation(progComposeNoStencil, "uZSlice"), z_s);
        glUniform1f(glGetUniformLocation(progComposeNoStencil, "uMaxDist"), maxDistColor);
        glUniform1f(glGetUniformLocation(progComposeNoStencil, "uZMinWorld"), zMinWorld);
        glUniform1f(glGetUniformLocation(progComposeNoStencil, "uZMaxWorld"), zMaxWorld);
